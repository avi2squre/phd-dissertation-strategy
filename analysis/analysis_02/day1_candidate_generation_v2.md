# Day 1 — Blind Independent Candidate Dissertation Direction Generation — Common Analysis Schema v2

**FORMAT-NORMALIZED DERIVATIVE OF FROZEN BLIND FIRST PASS. NO NEW SCIENTIFIC ANALYSIS PERFORMED.**

- **Original frozen artifact:** `analysis/analysis_02/day1_candidate_generation.md`
- **Original artifact SHA-256:** `d9fe21b5b5ae643fc9b1076707ba2fb95022c51c35af11df23b6a623f61f6b18`
- **Repository base SHA:** `86230f478b0a47a0198adbe325c42b0561fe8288`
- **Original status:** **FROZEN — BLIND FIRST PASS**
- **Post-advisor-amendment status:** Section 14 had already been amended before normalization to apply the IHI-primary-advisor plus Dr. Rui Zhang complementarity constraint; the original artifact was re-frozen after that amendment.
...
- **Deliberately excluded scientific-generation inputs:** substantive Analysis Stream 01 or 03 outputs; another stream's Day 1 candidates, rankings, recommendations, or literature interpretations; substantive Discussion Stream 01 or 03 entries; `candidate_programs/`; `decisions/current_rankings.md`; `decisions/scoring_framework.md`
...
- **Use of parallelism:** **NOT PRESENT IN ORIGINAL FROZEN ARTIFACT**
- **Stopping condition:** Search stopped after four distinct, falsifiable methodological directions had survived an initial collision check and additional searching was revealing closer baselines and narrower formulations, but was no longer changing the set that merits Day 2 adversarial review.

**Independence disclosures:** This artifact independently generated candidate dissertation directions rather than preserving the repository's historical candidate set. Historical Stream 02 reasoning informed the questions worth testing but did not determine which directions survived current scrutiny. Existing LIT identifiers were reused only as stable source references; source interpretations were made independently. Newly found sources were cited in place and were not added to the shared literature registry.
...
Claims of field-wide absence are deliberately avoided.
...
- **Other analyses consulted:** not assessed because the blind first-pass rule excluded other streams' substantive outputs.
...
|---|---|---|---|---|
| D02-01 | Dual-clock evidence-state control for longitudinal clinical agents | A provenance-linked belief-state representation and selective multi-action controller | ADVANCE WITH MAJOR UNCERTAINTY | Whether a learnable multi-action policy beats simple rules with reliable labels |
| D02-02 | Learned temporal clinical constraints for auditable representation repair | A probabilistic constraint-induction and proof-carrying repair framework | ADVANCE WITH MAJOR UNCERTAINTY | Whether learned “constraints” are valid and novel rather than site correlations |
| D02-03 | Machine-checkable causal data-fit contracts for EHR target-trial emulation | A formal contract that maps causal questions to data support, diagnostics, restricted estimands, or refusal | ADVANCE | Whether meaningful validity conditions can be machine-checked without implying causal certification |
| D02-04 | Change-attributed continual assurance for clinical foundation-model systems | A versioned failure-surface model with budgeted regression discovery and fault localization | ADVANCE WITH MAJOR UNCERTAINTY | Whether versioned attribution adds science beyond DAS plus standard regression testing |
...
**Central scientific object:** A provenance-linked belief-state representation and selective multi-action controller
...
### 7. Evidence-supported limitations
...
**Critical uncertainty / rejection trigger:** Whether a learnable multi-action policy beats simple rules with reliable labels
...
**Central scientific object:** A probabilistic constraint-induction and proof-carrying repair framework
...
**Critical uncertainty / rejection trigger:** Whether learned “constraints” are valid and novel rather than site correlations
...
**Central scientific object:** A formal contract that maps causal questions to data support, diagnostics, restricted estimands, or refusal
...
**Critical uncertainty / rejection trigger:** Whether meaningful validity conditions can be machine-checked without implying causal certification
...
**Central scientific object:** A versioned failure-surface model with budgeted regression discovery and fault localization
...
**Critical uncertainty / rejection trigger:** Whether versioned attribution adds science beyond DAS plus standard regression testing
...
| Falsifiability / discriminating experiment | Test whether dual-clock control beats strong retrieval, conformal-abstention, and simple-recency policies at matched action cost | Test whether learned constraint repair beats fixed rules plus strong language models under domain shift without harming semantic fidelity | Test whether contract verdicts predict bias or estimand mismatch better than diagnostics and checklists in known-ground-truth settings | Test whether sequential failure-surface modeling detects and localizes regressions better than static, stratified, and DAS-like testing at a fixed budget |
...
| Time to uncertainty resolution | Moderate: Aim 1 can test label reliability and oracle headroom, but the central controller claim requires Aim 2 | Moderate: the benchmark/formalism can come first, but the central uncertainty requires constraint-learning and transfer tests | Moderate: controlled Aim 1 cases can test expressiveness and verdict validity before multi-site work | Relatively short for controlled hidden-change tests; prospective transfer remains later and uncertain |
...
| IHI advisor/resource feasibility | Needs sequential decision/UQ plus clinical informatics | Needs neuro-symbolic/formal methods plus clinical NLP and experts | Needs genuine causal inference plus EHR/OMOP and formal specification | Needs evaluation/statistics/software reliability plus clinical safety |
...
Search stopped after four distinct, falsifiable methodological directions had survived an initial collision check and additional searching was revealing closer baselines and narrower formulations, but was no longer changing the set that merits Day 2 adversarial review.
